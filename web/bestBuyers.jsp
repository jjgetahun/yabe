...
<html>
<head>
    <title>Best Buyers Report Page</title>
        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">Best Buyers</h3>
                </div>
                <div class="panel-body">
                    ...
                    <table class="table table-striped">
                        ...
                        <%
                            ResultSet rs = database.DB.getBestBuyersReport();
                            while (rs != null && rs.next()) {
                        %>
                        <tbody>
                        <td> <%=rs.getInt("BidderID")%></td>
                        <td> <%=database.DB.getNameFromID(rs.getInt("BidderID"))%></td>
